...
export function StatCards({ stats, loading }: StatCardsProps) {
  ...
  const cards = [
    ...
    { label: "Completed Today", value: stats.completedToday, change: `${stats.completedJobs} all time` },
    { label: "Scheduled (Week)", value: stats.scheduledThisWeek, change: "This week" },
