...
export default function LandingPage() {
  ...
  return (
    <div className="relative bg-white text-gray-900 font-sans">
      <div
        aria-hidden="true"
        className="aurora-backdrop aurora-warm"
        style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: "auto", height: 900 }}
      />
      {/* Nav */}
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/60 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_-1px_0_0_rgba(255,255,255,0.6)]">
      ...
      <section className="relative mx-auto max-w-7xl px-6 lg:px-10 py-12">
        <div className="rounded-2xl border border-white/60 bg-white/50 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_20px_40px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
          <div className="flex">
      ...
      <section id="compliance" className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/70 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_20px_40px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {PRICING.map(({ name, price, seats, cta, ctaTo, highlight, badge, features, locked }) => (
              <div key={name} className={`rounded-2xl border bg-white/60 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_20px_40px_-20px_rgba(0,0,0,0.15)] p-8 ${highlight ? "border-[#e63f2a] ring-1 ring-[#e63f2a]" : "border-gray-200"}`}>
                <div className="flex items-center gap-2 mb-4">
