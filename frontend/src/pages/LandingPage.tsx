  ...
  return (
    <div className="relative bg-white text-gray-900 font-sans">
      ...
      <section className="relative mx-auto max-w-7xl px-6 lg:px-10 py-12">
        <div className="rounded-2xl border border-white/45 bg-white/35 backdrop-blur-sm backdrop-saturate-125 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),inset_1px_0_0_0_rgba(255,255,255,0.39),0_20px_40px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
          <div className="flex">
      ...
      <section id="compliance" className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/50 backdrop-blur-sm backdrop-saturate-125 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),inset_1px_0_0_0_rgba(255,255,255,0.39),0_20px_40px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
