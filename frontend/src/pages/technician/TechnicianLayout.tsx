...
export default function TechnicianLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <header className="sticky top-4 z-30 mx-4 flex h-[56px] items-center justify-between rounded-2xl border border-border bg-card px-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.5),inset_1px_0_0_0_rgba(255,255,255,0.325),inset_0_-1px_0_0_rgba(255,255,255,0.18),inset_-1px_0_0_0_rgba(255,255,255,0.11),0_14px_30px_-18px_rgba(0,0,0,0.25)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),inset_1px_0_0_0_rgba(255,255,255,0.039),inset_0_-1px_0_0_rgba(255,255,255,0.03),inset_-1px_0_0_0_rgba(255,255,255,0.02),0_14px_30px_-18px_rgba(0,0,0,0.5)]">
        <PneurosLogo size="sm" />
