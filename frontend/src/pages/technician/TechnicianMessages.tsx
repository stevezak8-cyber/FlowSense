...
export default function TechMessagesPage() {
  ...
  if (activeConv) {
    return (
      <div style={{ margin: "8px auto", maxWidth: 560, borderRadius: 28, overflow: "hidden", fontFamily: font, ...panel, color: T.text, display: "flex", flexDirection: "column", height: "calc(100% - 16px)" }}>
        {/* Thread header */}
